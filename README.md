...
- Clone this [repository](https://github.com/nicksonlangat/django_sub_users.git) `git clone https://github.com/nicksonlangat/django_sub_users.git`
...
- Main app is `accounts`. It uses a custom user model.
- Find the postman collection via `postman-collection.json` for API requests.